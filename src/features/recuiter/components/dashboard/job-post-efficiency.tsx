...
export function JobPostEfficiency() {
  return (
    <div className="rounded-2xl border border-gray-150 bg-white p-5 shadow-2xs hover:shadow-xs transition-all duration-200">
      {/* Header */}
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-gray-100 text-[10px] font-bold text-gray-400 uppercase tracking-wider">
              <th className="pb-2.5 font-semibold">Tin tuyển dụng</th>
              <th className="pb-2.5 font-semibold text-center">Xem</th>
              <th className="pb-2.5 font-semibold text-center">CV</th>
              <th className="pb-2.5 font-semibold text-center">Match</th>
              <th className="pb-2.5 font-semibold text-center">PV</th>
              <th className="pb-2.5 font-semibold text-center">Offer</th>
          ...
          <tbody className="divide-y divide-gray-100/50">
            {jobPosts.map((post, idx) => (
              ...
              >
                <td className="py-2.5 text-[11px] font-bold text-gray-800 truncate max-w-[180px]">
                  {post.title}
                </td>
                <td className="py-2.5 text-[11px] font-bold text-gray-600 text-center">
                  {post.views}
                </td>
                <td className="py-2.5 text-[11px] font-bold text-gray-600 text-center">
                  {post.cvs}
